...
export const metadata = {
    title: "Orders | Edurock - Education LMS Template",
...
const Orders = async ({ params }) => {
    ...
    // Sesuaikan pengecekan ini dengan struktur response gRPC Anda
    ...
    return (
        <PageWrapper>
            <main>
                <OrderMain orderData={res.response} status={finalStatus.orderStatusCode} />
                <ThemeController />
            </main>
        </PageWrapper>
    );
