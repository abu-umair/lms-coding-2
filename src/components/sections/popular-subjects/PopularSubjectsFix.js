...
const PopularSubjectsFix = () => {
  const isHome9 = useIsTrue("/home-9");
  const isHome9Dark = useIsTrue("/home-9-dark");
  const isHome10 = useIsTrue("/home-10");
  const isHome10Dark = useIsTrue("/home-10-dark");

  // Penyesuaian data subjects agar mencakup IT, Matematika, Bisnis, dan Soft Skill
  const subjects = [
    {
      title:
        isHome9 || isHome9Dark
          ...
          : isHome10 || isHome10Dark
            ? "Otomatisasi AI"
            : "Teknologi & IT",
      desc: "Kuasai coding, pengembangan web, data science, hingga AI dari dasar bersama praktisi industri.",
      navButton: true,
      image: isHome10 || isHome10Dark ? chatImage : null,
      id: 1,
      path: "/courses?category=it-tech",
      category: "Teknologi",
      svg: (
        <div className="relative w-20 h-[60px]">
          <svg className="absolute inline-block translate-y-3 translate-x-2 w-20 h-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path className="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark" fillRule="evenodd" clipRule="evenodd" d="M6.30281 28.9536H8.45394C9.05625 28.9536 9.48648 29.5426 9.48648 30.2495V36.8465C9.48648 37.6711 9.05625 38.2602 8.45394 38.2602H6.30281C5.78654 38.2602 5.27026 37.6711 5.27026 36.8465V30.2495C5.27026 29.5426 5.78654 28.9536 6.30281 28.9536Z" fill="#5F2DED"></path>
            <path className="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark" fillRule="evenodd" clipRule="evenodd" d="M13.7027 23.7833H15.8987C16.4257 23.7833 16.8649 24.4239 16.8649 25.3207V36.7228C16.8649 37.6196 16.4257 38.2602 15.8987 38.2602H13.7027C13.0879 38.2602 12.6487 37.6196 12.6487 36.7228V25.3207C12.6487 24.4239 13.0879 23.7833 13.7027 23.7833Z" fill="#5F2DED"></path>
            <path className="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark" fillRule="evenodd" clipRule="evenodd" d="M21.0596 19.6471H23.2108C23.727 19.6471 24.2433 20.412 24.2433 21.1769V36.7303C24.2433 37.6227 23.727 38.2602 23.2108 38.2602H21.0596C20.4573 38.2602 20.0271 37.6227 20.0271 36.7303V21.1769C20.0271 20.412 20.4573 19.6471 21.0596 19.6471Z" fill="#5F2DED"></path>
            <path className="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark" fillRule="evenodd" clipRule="evenodd" d="M28.4381 15.5109H30.5892C31.1055 15.5109 31.6217 16.1499 31.6217 17.0445V36.7265C31.6217 37.6212 31.1055 38.2602 30.5892 38.2602H28.4381C27.8357 38.2602 27.4055 37.6212 27.4055 36.7265V17.0445C27.4055 16.1499 27.8357 15.5109 28.4381 15.5109Z" fill="#5F2DED"></path>
            <path className="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark" fillRule="evenodd" clipRule="evenodd" d="M26.9989 7.6293L23.05 18.137L20.3744 15.4678C15.622 19.6266 9.96272 22.5976 3.63238 24.2568C1.36694 24.9297 0.353173 21.6176 2.74495 21.0505C8.47735 19.533 13.5443 16.8156 17.8363 13.1279L15.5453 10.8879L26.9989 7.6293Z" fill="#FFB31F"></path>
          </svg>
          <div className="service__bg__img w-20 h-[60px]">
            <svg className="w-20 h-[60px]" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path className="group-hover:fill-whiteColor dark:group-hover:fill-whiteColor-dark" fillRule="evenodd" clipRule="evenodd" d="M63.3775 44.4535C54.8582 58.717 39.1005 53.2202 23.1736 47.5697C7.2467 41.9192 -5.18037 32.7111 3.33895 18.4477C11.8583 4.18418 31.6595 -2.79441 47.5803 2.85105C63.5011 8.49652 71.8609 30.2313 63.3488 44.4865L63.3775 44.4535Z" fill="#5F2DED" fillOpacity="0.05"></path>
            </svg>
          </div>
        </div>
      ),
      ...
      title:
        isHome9 || isHome9Dark
          ...
          : isHome10 || isHome10Dark
            ? "Realitas Virtual"
            : "Sains & Matematika",
      desc: "Pertajam logika berpikir, pengolahan data analitis, dan penyelesaian masalah struktural.",
      navButton: true,
      id: 2,
      path: "/courses?category=math-science",
      category: "Sains",
      translate: true,
      ...
      title:
        isHome9 || isHome9Dark
          ...
          : isHome10 || isHome10Dark
            ? "Machine Learning"
            : "Bisnis & Kreatif",
      desc: "Pelajari manajemen bisnis modern, strategi pemasaran digital, hingga UI/UX desain praktis.",
      navButton: true,
      id: 3,
      path: "/courses?category=business-creative",
      category: "Kreatif",
      ...
      title:
        isHome9 || isHome9Dark
          ...
          : isHome10 || isHome10Dark
            ? "Layanan Awan AI"
            : "Pengembangan Diri",
      desc: "Tingkatkan soft skills, kemampuan komunikasi, kepemimpinan, dan kesiapan karir.",
      navButton: true,
      id: 4,
      path: "/courses?category=softskills",
      category: "Karir",
      translate: true,
    ...
    >
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 pt-30px gap-x-30px items-center">
          {/* Bagian Kiri: Teks Heading */}
          <div className="mb-30px lg:mb-0 pb-0 md:pb-30px xl:pb-0" data-aos="fade-up">
              ...
              {isHome9 || isHome9Dark ? (
                ...
                <div>
                  ...
                  <h3 className="text-3xl md:text-size-35 2xl:text-size-38 3xl:text-size-42 leading-10 md:leading-45px 2xl:leading-50px 3xl:leading-2xl font-bold text-blackColor dark:text-blackColor-dark pb-25px">
                    Akses Berbagai Materi <br /> Terbaik Untuk Semua
                  </h3>
                  <p className="text-sm md:text-base text-contentColor dark:text-contentColor-dark mb-10px 2xl:mb-50px">
                    Kami menyediakan kurikulum berstandar global yang dikurasi langsung dari para pakar. Mulai dari pemecahan masalah logika, teknologi modern, hingga strategi bisnis praktis siap menemani perjalanan belajarmu.
                  </p>
...
export default PopularSubjectsFix;