...
const About1 = ({ children, image, hideCounter }) => {
  ...
  // Counter disesuaikan untuk menonjolkan kualitas kurikulum dan kesiapan teknologi
  const counterItems = [
    {
      ...
      <div className={`container ${hideCounter ? "pt-70px pb-100px" : ""}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 pt-30px gap-x-30px">
          ...
          >
            ...
            {/* Mengubah durasi tahun menjadi pesan teknologi cerdas */}
            <div className="px-10px py-3 md:py-25px border-l-4 border-primaryColor shadow-experience absolute bottom-0 left-0 bg-white dark:bg-whiteColor-dark animate-move-var w-[290px]">
              <div className="counter flex items-center">
                <p className="text-[35px] text-primaryColor font-bold uppercase pr-10px leading-1ディー">
                  <span data-countup-number="100">100</span>%
                </p>
                <p className="text-blackColor dark:text-blackColor-dark font-bold leading-26px text-xs">
          ...
          <div data-aos="fade-up">
              ...
              {children ? (
                ...
                <>
                  ...
                  <span className="relative after:w-full after:h-[7px] after:bg-secondaryColor after:absolute after:left-0 after:bottom-3 md:after:bottom-5">
                    {isHome9 || isHome9Dark ? "Edukasi Anak" : "Belajar Cerdas"}
                  </span>{" "}
                  Masa Kini
                </>
              )}
            ...
            {/* Mengganti teks dummy lorem ipsum dengan keunggulan inovatif platformmu */}
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-6 pl-3 border-l-2 border-primaryColor">
              Kami percaya bahwa pendidikan terbaik lahir dari kombinasi keahlian praktisi hebat dan ekosistem teknologi cerdas yang mampu menyesuaikan diri dengan kecepatan belajar unik setiap individu.
            </p>

            {/* 3 Nilai Jual Utama (USP) Platform Baru */}
