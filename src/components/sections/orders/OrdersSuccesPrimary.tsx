...
const OrdersSuccesPrimary = ({ orderData }) => {
    const router = useRouter();
    console.log(orderData);
    const { number, total, orderStatusCode } = orderData;
    console.log(orderStatusCode);

    //! lanjut orderStatusCode (bisa lihat sistem yang ada di ecommerce) 
        ...
        <div className="min-h-screen relative overflow-hidden bg-[#f7f7f8]">
            ...
            <div className="pointer-events-none absolute inset-0">
                ...
                <motion.div
                    ...
                    className={[
                        "absolute -top-32 -left-20 w-[400px] h-[400px] rounded-full blur-2xl opacity-40 bg-green-200",
                    ].join(" ")}
                />
                ...
                <motion.div
                    ...
                    className={[
                        "bg-emerald-200 absolute -top-20 right-[-100px] w-[350px] h-[350px] rounded-full blur-2xl opacity-30",
                    ].join(" ")}
                />
                ...
                <motion.div
                    ...
                    className={[
                        "bg-green-100 absolute bottom-[-120px] left-1/3 w-[400px] h-[400px] rounded-full blur-2xl opacity-30",
                    ].join(" ")}
                />
                        ...
                        <div className="rounded-[28px] border border-slate-200/70 bg-white px-6 py-8 sm:px-10 sm:py-10">
                            <div className="flex flex-col items-center text-center">
                                <motion.div
                                    ...
                                    className={[
                                        "bg-green-50 ring-green-100 mb-6 flex h-24 w-24 items-center justify-center rounded-full ring-8",
                                    ].join(" ")}
                                >
                                    <div
                                        className={[
                                            "bg-green-100 text-green-600 flex h-14 w-14 items-center justify-center rounded-full text-2xl font-bold shadow-inner",
                                        ].join(" ")}
                                    >
                                        {ui.icon}
                                    </div>
                                ...
                                <span
                                    className={[
                                        "bg-green-50 text-green-700 mb-3 inline-flex items-center rounded-full px-4 py-1 text-sm font-medium ring-1",
                                    ].join(" ")}
                                >
                                    {ui.badge}
                                </span>
                                ...
                                <h1
                                    className={[
                                        "text-green-600 max-w-xl text-3xl font-semibold tracking-tight sm:text-4xl",
                                    ].join(" ")}
                                >
                                    {ui.title}
                                </h1>
                                ...
                                <div className="mt-8 grid w-full gap-3 sm:grid-cols-2 sm:gap-4">
                                    ...
                                    <button
                                        ...
                                        className={[
                                            "bg-green-500 hover:bg-green-600 inline-flex items-center justify-center rounded-2xl px-5 py-3.5 text-sm font-semibold text-white transition",
...
export default OrdersSuccesPrimary;