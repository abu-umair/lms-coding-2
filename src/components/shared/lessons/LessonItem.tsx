...
const LessonItem = ({
    ...
    return (
        <Draggable
            draggableId={initialData.id.toString()}
            index={index}
                        ...
                        {isInputCourse ? (
                            <div className="flex space-x-2">
                                <div className="flex space-x-1 bg-primaryColor p-0.5 rounded">
                                    <div {...provided.dragHandleProps} className="p-1 text-whiteColor hover:bg-whiteColor hover:text-primaryColor rounded transition-all">
                                        <Grip size={12} />
                                    </div>
                                    <CourseDialogLesson
