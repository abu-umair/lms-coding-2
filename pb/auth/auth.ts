...
/**
 * @generated from protobuf message auth.VerifyResponse
 */
...
/**
 * @generated from protobuf message auth.RequestOTPRequest
 */
export interface RequestOTPRequest {
}
/**
 * @generated from protobuf message auth.RequestOTPResponse
 */
...
class VerifyRequest$Type extends MessageType<VerifyRequest> {
    constructor() {
        super("auth.VerifyRequest", [
            { no: 1, name: "code_otp", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "buf.validate.field": { string: { minLen: "6", maxLen: "6" } } } }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message auth.VerifyResponse
 */
export const VerifyResponse = new VerifyResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RequestOTPRequest$Type extends MessageType<RequestOTPRequest> {
    constructor() {
        super("auth.RequestOTPRequest", []);
    }
    create(value?: PartialMessage<RequestOTPRequest>): RequestOTPRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<RequestOTPRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RequestOTPRequest): RequestOTPRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RequestOTPRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message auth.RequestOTPRequest
 */
export const RequestOTPRequest = new RequestOTPRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RequestOTPResponse$Type extends MessageType<RequestOTPResponse> {
    constructor() {
        super("auth.RequestOTPResponse", [
            { no: 1, name: "base", kind: "message", T: () => BaseResponse }
        ]);
    }
    create(value?: PartialMessage<RequestOTPResponse>): RequestOTPResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<RequestOTPResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RequestOTPResponse): RequestOTPResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RequestOTPResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* common.BaseResponse base = 1; */
        if (message.base)
            BaseResponse.internalBinaryWrite(message.base, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
