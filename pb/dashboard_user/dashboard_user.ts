...
/**
 * @generated from protobuf message dashboard_user.GetDashboardUserRequest
 */
...
/**
 * @generated from protobuf message dashboard_user.GetDashboardUserResponse
 */
export interface GetDashboardUserResponse {
    ...
    base?: BaseResponse;
    /**
     * @generated from protobuf field: repeated dashboard_user.CourseInfoUser courses = 2
     */
    courses: CourseInfoUser[];
}
/**
 * @generated from protobuf message dashboard_user.CourseInfoUser
 */
...
class GetDashboardUserRequest$Type extends MessageType<GetDashboardUserRequest> {
    constructor() {
        super("dashboard_user.GetDashboardUserRequest", [
            { no: 1, name: "user_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "field_mask", kind: "message", T: () => FieldMask }
        ]);
    }
    create(value?: PartialMessage<GetDashboardUserRequest>): GetDashboardUserRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.userId = "";
        if (value !== undefined)
            reflectionMergePartial<GetDashboardUserRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetDashboardUserRequest): GetDashboardUserRequest {
    ...
    internalBinaryWrite(message: GetDashboardUserRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string user_id = 1; */
        if (message.userId !== "")
...
/**
 * @generated MessageType for protobuf message dashboard_user.GetDashboardUserRequest
 */
export const GetDashboardUserRequest = new GetDashboardUserRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetDashboardUserResponse$Type extends MessageType<GetDashboardUserResponse> {
    constructor() {
        super("dashboard_user.GetDashboardUserResponse", [
            { no: 1, name: "base", kind: "message", T: () => BaseResponse },
            { no: 2, name: "courses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CourseInfoUser }
        ]);
    }
    create(value?: PartialMessage<GetDashboardUserResponse>): GetDashboardUserResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.courses = [];
        if (value !== undefined)
            reflectionMergePartial<GetDashboardUserResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetDashboardUserResponse): GetDashboardUserResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* common.BaseResponse base */ 1:
                    ...
                    break;
                case /* repeated dashboard_user.CourseInfoUser courses */ 2:
    ...
    internalBinaryWrite(message: GetDashboardUserResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* common.BaseResponse base = 1; */
        if (message.base)
            BaseResponse.internalBinaryWrite(message.base, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* repeated dashboard_user.CourseInfoUser courses = 2; */
...
/**
 * @generated MessageType for protobuf message dashboard_user.GetDashboardUserResponse
 */
export const GetDashboardUserResponse = new GetDashboardUserResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CourseInfoUser$Type extends MessageType<CourseInfoUser> {
    constructor() {
        super("dashboard_user.CourseInfoUser", [
...
/**
 * @generated MessageType for protobuf message dashboard_user.CourseInfoUser
 */
export const CourseInfoUser = new CourseInfoUser$Type();
/**
 * @generated ServiceType for protobuf service dashboard_user.DashboardUserService
 */
export const DashboardUserService = new ServiceType("dashboard_user.DashboardUserService", [
    { name: "GetDashboardUser", options: {}, I: GetDashboardUserRequest, O: GetDashboardUserResponse }
]);
