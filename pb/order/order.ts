...
/**
 * @generated from protobuf message order.CreateOrderRequestCourseItem
 */
export interface CreateOrderRequestCourseItem {
    /**
     * @generated from protobuf field: string id = 1
     */
    id: string; // ?tidak diisi karena nested
    /**
...
export interface CreateOrderRequest {
    ...
    notes: string;
    /**
     * @generated from protobuf field: repeated order.CreateOrderRequestCourseItem courses = 5
     */
    courses: CreateOrderRequestCourseItem[]; // (course apa saja)
}
/**
...
/**
 * @generated from protobuf message order.ListOrderAdminResponseItemCourse
 */
export interface ListOrderAdminResponseItemCourse {
    /**
     * @generated from protobuf field: string id = 1
     */
    id: string;
...
export interface ListOrderAdminResponseItem {
    ...
    createdAt?: Timestamp;
    /**
     * @generated from protobuf field: repeated order.ListOrderAdminResponseItemCourse courses = 7
     */
    courses: ListOrderAdminResponseItemCourse[];
}
/**
...
/**
 * @generated from protobuf message order.ListOrderResponseItemCourse
 */
export interface ListOrderResponseItemCourse {
    /**
     * @generated from protobuf field: string id = 1
     */
    id: string;
...
export interface ListOrderResponseItem {
    ...
    createdAt?: Timestamp;
    /**
     * @generated from protobuf field: repeated order.ListOrderResponseItemCourse courses = 7
     */
...
class CreateOrderRequestCourseItem$Type extends MessageType<CreateOrderRequestCourseItem> {
    constructor() {
        super("order.CreateOrderRequestCourseItem", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "quantity", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<CreateOrderRequestCourseItem>): CreateOrderRequestCourseItem {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.id = "";
        message.quantity = 0n;
        if (value !== undefined)
            reflectionMergePartial<CreateOrderRequestCourseItem>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateOrderRequestCourseItem): CreateOrderRequestCourseItem {
    ...
    internalBinaryWrite(message: CreateOrderRequestCourseItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
...
/**
 * @generated MessageType for protobuf message order.CreateOrderRequestCourseItem
 */
export const CreateOrderRequestCourseItem = new CreateOrderRequestCourseItem$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateOrderRequest$Type extends MessageType<CreateOrderRequest> {
    constructor() {
        super("order.CreateOrderRequest", [
            ...
            { no: 5, name: "courses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => CreateOrderRequestCourseItem }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string notes */ 4:
                    ...
                    break;
                case /* repeated order.CreateOrderRequestCourseItem courses */ 5:
                    message.courses.push(CreateOrderRequestCourseItem.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: CreateOrderRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated order.CreateOrderRequestCourseItem courses = 5; */
        for (let i = 0; i < message.courses.length; i++)
            CreateOrderRequestCourseItem.internalBinaryWrite(message.courses[i], writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class ListOrderAdminResponseItemCourse$Type extends MessageType<ListOrderAdminResponseItemCourse> {
    constructor() {
        super("order.ListOrderAdminResponseItemCourse", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    create(value?: PartialMessage<ListOrderAdminResponseItemCourse>): ListOrderAdminResponseItemCourse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.id = "";
        message.name = "";
        message.price = 0;
        message.quantity = 0n;
        if (value !== undefined)
            reflectionMergePartial<ListOrderAdminResponseItemCourse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListOrderAdminResponseItemCourse): ListOrderAdminResponseItemCourse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ListOrderAdminResponseItemCourse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string name = 2; */
...
/**
 * @generated MessageType for protobuf message order.ListOrderAdminResponseItemCourse
 */
export const ListOrderAdminResponseItemCourse = new ListOrderAdminResponseItemCourse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ListOrderAdminResponseItem$Type extends MessageType<ListOrderAdminResponseItem> {
    constructor() {
        super("order.ListOrderAdminResponseItem", [
            ...
            { no: 7, name: "courses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListOrderAdminResponseItemCourse }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.protobuf.Timestamp created_at */ 6:
                    ...
                    break;
                case /* repeated order.ListOrderAdminResponseItemCourse courses */ 7:
                    message.courses.push(ListOrderAdminResponseItemCourse.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ListOrderAdminResponseItem, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated order.ListOrderAdminResponseItemCourse courses = 7; */
        for (let i = 0; i < message.courses.length; i++)
            ListOrderAdminResponseItemCourse.internalBinaryWrite(message.courses[i], writer.tag(7, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class ListOrderResponseItemCourse$Type extends MessageType<ListOrderResponseItemCourse> {
    constructor() {
        super("order.ListOrderResponseItemCourse", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "price", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 4, name: "quantity", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
    ...
    create(value?: PartialMessage<ListOrderResponseItemCourse>): ListOrderResponseItemCourse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.id = "";
        message.name = "";
        message.price = 0;
        message.quantity = 0n;
        if (value !== undefined)
            reflectionMergePartial<ListOrderResponseItemCourse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListOrderResponseItemCourse): ListOrderResponseItemCourse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ListOrderResponseItemCourse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string id = 1; */
        if (message.id !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.id);
        /* string name = 2; */
...
/**
 * @generated MessageType for protobuf message order.ListOrderResponseItemCourse
 */
export const ListOrderResponseItemCourse = new ListOrderResponseItemCourse$Type();
// @generated message type with reflection information, may provide speed optimized methods
